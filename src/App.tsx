...
import BusCollectionTest from './components/BusCollectionTest';
...
function App() {
  ...
  const [showBusTest, setShowBusTest] = useState(false);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-3xl font-bold text-gray-900">전국 교통정보 플랫폼</h1>
      ...
      <footer className="bg-white border-t border-gray-200 mt-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center text-gray-600 text-sm">
            ...
            <p className="text-xs text-gray-500">매일 자동 업데이트 · SEO 최적화 · 롱테일 키워드 전략</p>
            <div className="mt-4 flex justify-center gap-4 text-xs">
              <a href="#bus-test" className="text-blue-600 hover:underline">데이터 수집</a>
              <span className="text-gray-400">|</span>
              <button onClick={() => setShowAdminPanel(true)} className="text-blue-600 hover:underline">
                관리자 (Ctrl+Shift+A)
              </button>
            </div>
          </div>
